...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 2
    answer = count_cosines_from(3, 6, 0.1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(1, 9, 0.6)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 3.1801  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 13)
